...
public class AuthServiceImpl implements AuthService {
    ...
    public AuthServiceImpl(UserRepo userRepo, PasswordHasher passwordHasher) {
    ...
    @Override
    public JwtPayloadInput login(LoginRequest request) {
        Optional<User> queryResult = userRepo.getUserByUsername(request.username());
        ...
        return new JwtPayloadInput(user.getUsername(), user.getRole());
    }
